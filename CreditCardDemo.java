...
public class CreditCardDemo {
    public static void main(String[] args) {
        final Money LIMIT = new Money(1000);          // Credit limit is 1000
        final Money FIRST_AMOUNT = new Money(200);    // Charge 200, 800 left
        final Money SECOND_AMOUNT = new Money(10.02); // 10.02
        final Money THIRD_AMOUNT = new Money(25);     // 25
        final Money FOURTH_AMOUNT = new Money(990);   // This should show error
